...
intoDatetime <- function(df){
  ...
  df[df$time_period == 2076, "time_period"] <- 2019 # Nepal
  df[df$time_period == 2562, "time_period"] <- 2019 # Thailand
...
```{r}
export_data <- write_csv(all_data, 'StackedDigitalConnectivity.csv' )
```
